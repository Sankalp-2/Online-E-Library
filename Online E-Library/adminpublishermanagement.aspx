<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="adminpublishermanagement.aspx.cs" Inherits="Online_E_Library.adminpublishermanagement" %>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-5">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col">
                                <center>
                                        <img width="93px" src="images/All necessary Images/imgs/publisher.png" />         
                                    </center>
                            </div>
                        </div>
                        <div class="row">
                ...
                <br><p></p><br /><p></p><br /><br><p></p>&nbsp<br />&nbsp
            </div>
