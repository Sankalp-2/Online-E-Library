<%@ Page Title="" Language="C#" MasterPageFile="~/publisher.Master" AutoEventWireup="true" CodeBehind="book_publish.aspx.cs" Inherits="Online_E_Library.book_publish" %>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col">
                                <center>
                                    <img id="imgview" height="150px" width="100px" src="images/All%20necessary%20Images/imgs/books1.png" />
                                </center>
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                ...
                                <div class="form-group">
                                    <asp:TextBox CssClass="form-control" ID="TextBox2" runat="server" placeholder="Book Name" OnTextChanged="TextBox2_TextChanged"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    <asp:TextBox class="form-control" ID="TextBox" runat="server">
